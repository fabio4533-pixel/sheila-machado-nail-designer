(function () {
  ...
  async function api(payload) {
    ...
    if (!r.ok) {
      throw new Error(
        data.error || "Erro ao carregar bloqueios."
      );
    }
    ...
    painel.innerHTML = `
      <div class="top">
        <div>
          ...
          <div class="small">
            Clique em um dia para ver os bloqueios
          </div>
        </div>

        <button onclick="carregarCalendarioBloqueios()">
          Atualizar
        </button>
      </div>
    ...
    detalhes.innerHTML = `
      ...
      ${bloqueios.map(x => `
        ...
        >
          ...
          <button
            class="danger"
            onclick="desbloquearCalendario(${x.id})"
          >
            Desbloquear
          </button>
        </div>
  ...
  window.carregarCalendarioBloqueios =
    carregarCalendarioBloqueios;

  window.desbloquearCalendario =
    desbloquear;
